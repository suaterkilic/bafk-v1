...
const Product = () => {
  return (
    <Fragment>
      <div
        footer-data="1"
        className="barberry-has-cart-fixed product-template-default single single-product postid-3986 wp-embed-responsive theme-barberry woocommerce woocommerce-page woocommerce-no-js wpb-js-composer js-comp-ver-6.3.0 vc_responsive no-offcanvas-animation header-has-title header-has-overlap catalog-ajax-filter posts-has-parallax has-wishlist bb_classic_notif tag-cloud-default"
      >
        <Layout>
          <div id="primary" className="footer-parent product-content-area">
